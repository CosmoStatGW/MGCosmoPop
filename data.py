...
def load_mock_data():
    with h5py.File(os.path.join(utils.dataPath,'observations.h5'), 'r') as phi: #observations.h5 has to be in the same folder as this code
...
def load_injections_data_mock():   
    ...
    with h5py.File(os.path.join(utils.dataPath,'selected.h5'), 'r') as f:
